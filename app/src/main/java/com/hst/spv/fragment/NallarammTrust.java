 ...
 * Use the {@link NallarammTrust#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NallarammTrust extends Fragment implements IServiceListener, DialogClickListener, NallaramTrustAdapter.OnItemClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_nallaramm_trust, container, false);
...
//            }
            ...
            mAdapter = new NallaramTrustAdapter(newsFeedArrayList, this);
...
//                    paguthiID = "ALL";
//                }
                jsonObject.put(SPVConstants.KEY_NEWSFEED_ID, "6");
