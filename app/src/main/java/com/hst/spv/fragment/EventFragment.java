...
import com.hst.spv.adapter.EventTabAdapter;
...
public class EventFragment extends Fragment {
    ...
    private void initialiseTabs() {
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.all_events)));
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.local_events)));
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.state_events)));

        final EventTabAdapter adapter = new EventTabAdapter(getChildFragmentManager());
