...
public class PreferenceStorage {
    ...
    public static void saveLanguageId(Context context, String lang) {
        SharedPreferences sharedPreferences = android.preference.PreferenceManager
                .getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(SPVConstants.KEY_LANG_ID, lang);
        editor.apply();
    }
    ...
    public static String getLanguageId(Context context) {
        SharedPreferences sharedPreferences = android.preference.PreferenceManager
                .getDefaultSharedPreferences(context);
        String lang;
        lang = sharedPreferences.getString(SPVConstants.KEY_LANG_ID, "");
        return lang;
    }
    /*End*/
    ...
    public static void saveMobileNo(Context context, String type) {
        SharedPreferences sharedPreferences = android.preference.PreferenceManager
                .getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(SPVConstants.KEY_MOBILE, type);
        editor.apply();
    }
    ...
    public static String getMobileNo(Context context) {
        SharedPreferences sharedPreferences = android.preference.PreferenceManager
                .getDefaultSharedPreferences(context);
        String fullName;
        fullName = sharedPreferences.getString(SPVConstants.KEY_MOBILE, "");
        return fullName;
    }
    /*End*/
    /* User Image*/
